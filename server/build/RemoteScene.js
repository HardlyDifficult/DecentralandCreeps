...
export default class HouseScene extends DCL.ScriptableScene {
    ...
    async render() {
        return (DCL.createElement("scene", null,
            DCL.createElement("material", { id: "floorTileMaterial", albedoTexture: "./assets/StoneFloor.png" }),
            DCL.createElement("plane", { position: { x: 10, y: 0, z: 10 }, rotation: { x: 90, y: 0, z: 0 }, scale: 19.99, color: "#666666" }),
            DCL.createElement("gltf-model", { src: "assets/Archway/StoneArchway.gltf", position: { x: 10, y: 0, z: 2 }, rotation: { x: 0, y: 180, z: 0 }, scale: { x: 1, y: 1, z: 1.5 } }),
            DCL.createElement("gltf-model", { src: "assets/Archway/StoneArchway.gltf", position: Helpers.gridToWorld(getState().path[getState().path.length - 2]), scale: { x: 1, y: 1, z: 1.5 } }),
            this.renderTiles(),
            this.renderTraps(),
            this.renderEntities(),
...
function getNeighborCount(grid, position) {
    const neighbors = [
